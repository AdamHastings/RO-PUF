...
LOGS_DIR = "logs/XMD/"
TIMING_LOGS = '/home/adam/backup/X11.2.24.16/*.log'
...
def parseDate(logFile):
	date = datetime.datetime.strptime(logFile, '/home/adam/backup/X11.2.24.16/output-%m.%d.%y-%H.%M.log')
	return date
...
def plotTiming( timing, testTiming, control, test, filename ):
	...
	pl.axis([x1,x2, 25000000, 25250000])
	pl.title('Characterization Results')
	pl.xlabel('Time: Hours from start of experiments in 4 hour increments')
	pl.ylabel('Averages')
