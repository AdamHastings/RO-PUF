...
void interrupt_handler_dispatcher(void* ptr) {
	...
	if (intc_status & XPAR_XPS_TIMER_0_INTERRUPT_MASK)
	{
		...
		{
			currentInterval = 0;
			unsigned int count1 = RING_OSC_mReadSlaveReg0(XPAR_RING_OSC_1_BASEADDR, RING_OSC_SLV_REG0_OFFSET);
			unsigned int count2 = RING_OSC_mReadSlaveReg0(XPAR_RING_OSC_2_BASEADDR, RING_OSC_SLV_REG0_OFFSET);
