/*****************************************************************************
* Filename:          E:\Adam\Characterizing\characterizer_planahead\dut_mb_v4lx60_template_pre_rapidsmith\hw/drivers/ring_osc_v1_03_a/src/ring_osc_selftest.c
* Version:           1.03.a
...
XStatus RING_OSC_SelfTest(void * baseaddr_p)
{
  ...
  RING_OSC_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = RING_OSC_mReadSlaveReg4(baseaddr, 0);
  ...
  RING_OSC_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = RING_OSC_mReadSlaveReg5(baseaddr, 0);
  ...
  RING_OSC_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = RING_OSC_mReadSlaveReg6(baseaddr, 0);
  ...
  RING_OSC_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = RING_OSC_mReadSlaveReg7(baseaddr, 0);
